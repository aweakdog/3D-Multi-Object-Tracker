...
class SemanticKittiDetectionDataset:
...
class SemanticKittiTrackingDataset:
    def __init__(self,root_path,seq_id,ob_path = None,load_image=False,load_points=False,type=["Car"]):
        ...
        self.root_path = root_path
        self.velo_path = os.path.join(self.root_path,self.seq_name,"velodyne")
        # self.image_path = os.path.join(self.root_path,self.seq_name,"image_02") # none
        self.calib_path = os.path.join(self.root_path,self.seq_name,"calib.txt")
        self.pose_path = os.path.join(self.root_path,self.seq_name, "poses.txt")
        self.type = type
